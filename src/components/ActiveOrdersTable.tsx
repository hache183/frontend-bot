...
const ActiveOrdersTable: React.FC<ActiveOrdersTableProps> = ({ orders, onApprove }) => {
  return (
            ...
            <tr key={idx} className="border-b border-gray-700">
              ...
              <td className="px-4 py-2">
                {order.manualApproval ? (
                  <button className="bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded" onClick={() => onApprove(order)}>
                    Approve
                  </button>
                ) : (
